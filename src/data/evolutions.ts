// Evolution data for all cards that have evolutions in Cracked Royale
// 6 evolution shards unlock an evolution for any card
// Based on official Cracked Royale evolutions (excludes Mega Knight per user request)
...
// All official Cracked Royale evolutions (33 total, excluding Mega Knight)
export const evolutions: Evolution[] = [
  // Common evolutions
  {
    ...
    damageBonus: 0,
    specialEffect:
      "+35% attack speed and movement speed for 3s every time they attack",
    cycles: 1,
  },
  {
    cardId: "skeletons",
  ...
  },
  {
    ...
    damageBonus: 0,
    specialEffect:
      "60% damage reduction shield while moving or deploying until first hit",
    cycles: 2,
  },
  {
    cardId: "archers",
  ...
  },
  {
    ...
    damageBonus: 0,
    specialEffect:
      "Bombs bounce twice after initial hit (2.5 tiles apart each)",
    cycles: 2,
  },
  {
    cardId: "bats",
  ...
  },
  {
    ...
    damageBonus: 0,
    specialEffect:
      "Each attack summons a Tornado pulling enemies in 5.5-tile radius",
    cycles: 2,
  },
  {
    cardId: "musketeer",
    ...
    damageBonus: 0,
    specialEffect:
      "3 sniper shots dealing +80% damage with infinite vertical range",
    cycles: 2,
  },
  {
    cardId: "wizard",
    ...
    damageBonus: 0,
    specialEffect:
      "Shield that deals damage and knockback in 3-tile radius when destroyed",
    cycles: 1,
  },
  {
    cardId: "baby-dragon",
    ...
    damageBonus: 0,
    specialEffect:
      "Creates wind burst: -30% enemy speed, +50% ally speed for 5s",
    cycles: 2,
  },
  {
    cardId: "battle-ram",
    ...
    damageBonus: 0,
    specialEffect:
      "Knockback on charge, double damage, repeatedly rams until destroyed. Spawns Evolved Barbarians",
    cycles: 2,
  },
  ...
  // Epic evolutions
  {
    ...
    damageBonus: 0,
    specialEffect:
      "Spawns 2 barrels mirrored. One has real Goblins, other has weaker decoys",
    cycles: 2,
  },
  {
    cardId: "goblin-giant",
  ...
  },
  {
    ...
    damageBonus: 0,
    specialEffect:
      "Defeating units spawns healing butterfly. Can overheal to +66% max HP",
    cycles: 1,
  },
  {
    cardId: "witch",
    ...
    damageBonus: 0,
    specialEffect:
      "When her Skeletons die, Witch heals. Can overheal to 124% HP",
    cycles: 1,
  },
  {
    ...
    damageBonus: 0,
    specialEffect:
      "Lightning chains infinitely. After 3rd chain: no stun, -33% damage",
    cycles: 1,
  },
  {
    cardId: "lumberjack",
    ...
    damageBonus: 0,
    specialEffect:
      "Death spawns invincible Ghost that attacks until Rage expires",
    cycles: 2,
  },
  {
    cardId: "hunter",
    ...
    damageBonus: 0,
    specialEffect:
      "Throws net immobilizing troops for 3s. Grounds flying units. 5s cooldown",
    cycles: 2,
  },
  {
    cardId: "executioner",
    ...
    damageBonus: 0,
    specialEffect:
      "Axe deals extra damage and 1.5-tile knockback within 3.5 tiles",
    cycles: 1,
  },
  {
    ...
    damageBonus: 0,
    specialEffect:
      "Keeps damage stage between targets for 9s. 4th stage at 20s deals 2x damage",
    cycles: 2,
  },
  {
    ...
    damageBonus: 0.61,
    specialEffect:
      "+1 barrel. Drops at 75% HP and on death. Each spawns 7 Skeletons",
    cycles: 2,
  },
  ...
  // Buildings evolutions
  {
    ...
    damageBonus: 0,
    specialEffect:
      "-20% attack period. Each shot spawns a Goblin where it lands",
    cycles: 2,
  },
  {
    cardId: "tesla",
    ...
    damageBonus: 0,
    specialEffect:
      "Surfaces with 6-tile radius electric pulse dealing damage and 0.5s stun",
    cycles: 2,
  },
  {
    cardId: "cannon",
    ...
    damageBonus: 0,
    specialEffect:
      "Deploys with 9 bombs raining from sky dealing damage and knockback",
    cycles: 2,
  },
  {
    cardId: "goblin-cage",
    ...
    damageBonus: 0,
    specialEffect:
      "Drags ground troops into cage. Brawler hits trapped troop every 1s, immune to damage",
    cycles: 1,
  },
  {
    cardId: "goblin-drill",
    ...
    damageBonus: 0,
    specialEffect:
      "At 66% and 33% HP, rotates 90° around Crown Tower spawning Goblins",
    cycles: 2,
  },
  {
    cardId: "furnace",
    ...
    damageBonus: 0,
    specialEffect:
      "While attacking, spawn period reduced to 2.4s, alternating left/right",
    cycles: 2,
  },
  ...
  // Spell evolutions
  {
    ...
    damageBonus: 0,
    specialEffect:
      "After initial Zap, radius stays and grows 0.5 tiles with same stun and damage",
    cycles: 2,
  },
  {
    ...
    damageBonus: 0,
    specialEffect:
      "+25% slow duration. Rolls 4.5 tiles pulling all troops in its path",
    cycles: 2,
  },
  ...
  // Other troop evolutions
  {
    ...
    damageBonus: 0,
    specialEffect:
      "Attack leaves sparks dealing damage every 0.25s for 3s. -15% enemy speed",
    cycles: 2,
  },
  {
    ...
    damageBonus: 0,
    specialEffect:
      "When shield is knocked off after 2.5 tiles, charges at Very Fast with 2x damage",
    cycles: 1,
  },
  {
    cardId: "ice-spirit",
    ...
    damageBonus: 0,
    specialEffect:
      "+33% splash radius. Freezes 1.1s, then again after 3s. Leaves freeze zone on death",
    cycles: 2,
  },
  {
    ...
    damageBonus: 0,
    specialEffect:
      "Barrel break deals damage. Continue running Very Fast, deal 50% damage on impact",
    cycles: 2,
  },
  {
    cardId: "dart-goblin",
    ...
    damageBonus: 0,
    specialEffect:
      "Attacks apply stacking poison. Level 2 at 4 hits, Level 3 at 7 hits. Poison trail",
    cycles: 2,
  },
  {
    ...
    damageBonus: 0,
    specialEffect:
      "+1 Skeleton. Includes General with shield. Dead Skeletons become invisible until General dies",
    cycles: 2,
  },
  {
    cardId: "royal-ghost",
    ...
    damageBonus: 0,
    specialEffect:
      "Invisible attacks spawn 2 Souldiers with 51% damage and 6.7% HP",
    cycles: 2,
  },
  {
    cardId: "royal-hogs",
    ...
    damageBonus: 0,
    specialEffect:
      "Spawn flying. Fall damage deals 155% of normal damage on first attack",
    cycles: 2,
  },
];
