// Cracked Royale Trophy Road Arenas
...
export const ARENAS: Arena[] = [
  ...
  },
  {
    ...
    emoji: "🎃",
    color: "#6a4a7c",
    bgGradient: "from-fuchsia-700 to-fuchsia-900",
  },
  {
    id: 13,
    name: "Rascal's Hideout",
    trophiesRequired: 1200,
    emoji: "🏴‍☠️",
    color: "#4a4a5c",
