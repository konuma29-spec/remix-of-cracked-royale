...
const CARD_IMAGES: Record<string, string> = {
  ...
  'evo-goblin-giant': '/evo-goblin-giant.png',
  ...
  'evo-electro-dragon': '/evo-electro-dragon.png',
  ...
  'evo-wall-breakers': '/evo-wall-breakers.png',
    ...
    if (isLegendary) {
      return (
        <div
          ...
          style={{
            clipPath: 'polygon(50% 10%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)',
          }}
        >
          <img
            src={imageSrc}
