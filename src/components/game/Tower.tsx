...
export function Tower({ tower }: TowerProps) {
  ...
  const size = tower.type === "king" ? "w-24 h-24" : tower.type === "princess" && tower.owner === "player" && tower.id === "player-princess-left" ? "w-18 h-18" : tower.type === "princess" && tower.owner === "player" ? "w-20 h-20" : tower.type === "princess" ? "w-14 h-14" : "w-16 h-16";
